...
import { Loader2, Mail, Phone, Send, Trash2, Upload } from "lucide-react";
...
// BIỂU TƯỢNG SOCIAL ICONS TYPE-SAFE
...
// CẤU HÌNH HOẠT ẢNH SPRING MƯỢT MÀ
...
export default function ContactPage() {
  ...
  // State quản lý file đính kèm 3D (.stl, .obj, .3mf...)
  ...
  // Xử lý đính kèm file (Giới hạn 5MB)
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      // 1. Tải tệp đính kèm lên Supabase Storage
      if (attachedFile) {
      ...
      if (response.ok && data.success) {
        toast.success(
          "Gửi tin nhắn liên hệ thành công! Boo Space sẽ phản hồi bạn sớm nhất ✨",
        );
  ...
  const cleanPhoneLink = siteConfig.contact.phone.replace(/\s+/g, "");
  ...
  return (
    <div className="bg-[#FCFAF2] text-[#1E1C1A] min-h-screen antialiased selection:bg-[#EAE5D9]">
      <div className="mx-auto max-w-[1440px] px-4 py-16 sm:px-6 lg:px-8 border-x border-[#E1DDD5] bg-[#FCFAF2]/50">
        ...
        >
          {/* CỘT TRÁI (1/3): THÔNG TIN LIÊN HỆ ĐA KÊNH CHUẨN CONFIG */}
            ...
            >
              <Card className="rounded-3xl border border-[#DCD6CC] bg-white p-6 flex flex-col justify-between h-40 relative overflow-hidden transition-all">
                <CardHeader className="p-0">
                  ...
                  <CardDescription className="text-black font-bold text-xl mt-3 font-serif">
                    {siteConfig.contact.phone}
                  </CardDescription>
                </CardHeader>
                <CardContent className="p-0">
                  <a
                    href={`https://zalo.me/${cleanPhoneLink}`}
                    target="_blank"
                    rel="noreferrer"
            ...
            >
              <Card className="rounded-3xl border border-[#DCD6CC] bg-white p-6 flex flex-col justify-between h-40 relative overflow-hidden transition-all">
                <CardHeader className="p-0">
                  ...
                  <CardDescription className="text-black font-bold text-base mt-3 font-serif">
            ...
            >
              <Card className="rounded-3xl border border-[#DCD6CC] bg-white p-6 flex flex-col justify-between h-40 relative overflow-hidden transition-all">
                <CardHeader className="p-0">
                  ...
                  <CardDescription className="text-black font-bold text-xs mt-2 font-serif leading-relaxed">
          ...
          {/* CỘT PHẢI (2/3): FORM YÊU CẦU BÁO GIÁ THIẾT KẾ & TẢI FILE 3D */}
          <motion.div
            variants={blockVariants}
