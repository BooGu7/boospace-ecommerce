...
import { Loader2, Mail, Send, Trash2, Upload } from "lucide-react";
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (response.ok && data.success) {
        toast.success("Gửi tin nhắn liên hệ thành công! Chúng tôi sẽ phản hồi bạn sớm nhất ✨");
      ...
      <div className="mx-auto max-w-[1440px] px-4 py-16 sm:px-6 lg:px-8 border-x border-[#E1DDD5] bg-[#FCFAF2]/50">
        ...
        >
          ...
          <div className="space-y-6 lg:col-span-1 text-left">
            {/* Card Email */}
            <motion.div variants={blockVariants} whileHover="hover" className="block">
          ...
          <motion.div variants={blockVariants} className="lg:col-span-2 text-left">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2 text-left">
                    <Label className="text-[11px] font-mono font-bold text-[#5c544d] uppercase tracking-wider block">
                      Tệp đính kèm STL / 3MF / DWG / STEP / Bản vẽ phác thảo (Nếu có) (Tối đa 5MB)
                    </Label>
