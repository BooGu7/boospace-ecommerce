...
export interface CheckoutProvider {
  createSession(cart: Cart, customer?: { email: string; shippingAddress?: Address }): Promise<CheckoutSession>;
...
export interface ProductRepository {
  list(filters?: ProductFilters, sort?: SortOption, pagination?: PaginationParams): Promise<PaginatedResult<Product>>;
  getBySlug(slug: string): Promise<Product | null>;
  getById(id: string): Promise<Product | null>;
  getFeatured(limit?: number): Promise<Product[]>;
  getByCategory(categorySlug: string, pagination?: PaginationParams): Promise<PaginatedResult<Product>>;
...
export interface OrderRepository {
  list(userId?: string, pagination?: PaginationParams): Promise<PaginatedResult<Order>>;
