            ...
            <div className="space-y-3 pt-6 border-t border-[#E1DDD5]/60 max-w-sm">
              ...
              >
                <input
                  ...
                  required
                  className="flex-1 bg-transparent px-4 py-2 text-xs font-mono tracking-wider outline-none text-black placeholder:text-[#5C564E]/70"
                />
                {/* Đã sửa aria-label đồng bộ chứa từ "GET" [1.1] */}
                <button
                  type="submit"
                  disabled={submitting}
