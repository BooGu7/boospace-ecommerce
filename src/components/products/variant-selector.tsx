        ...
        <div key={optionName}>
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            {Array.from(values).map((value) => {
              ...
              const isSelected = selectedVariant?.options.some((o) => o.name === optionName && o.value === value);
              const isAvailable =
                matchingVariant && (matchingVariant.inventory.quantity > 0 || matchingVariant.inventory.allowBackorder);
