...
export function ScrollytellingSection({
  ...
  const backgroundColor = useTransform(scrollYProgress, [0, 0.5, 1], ["#FCFAF2", "#1C1A18", "#111111"]);
    ...
    <>
      <div className="block md:hidden space-y-16 px-4 py-16 bg-[#FCFAF2] text-[#1E1C1A]">
        <div className="space-y-6">
          <div className="text-xs font-mono text-amber-600 uppercase tracking-widest font-bold">01 / ANALOG TOUCH</div>
          <h3 className="text-3xl font-bold font-serif leading-tight">{s1Title}</h3>
          ...
          <div className="relative aspect-video w-full rounded-2xl overflow-hidden border border-[#E1DDD5]">
            <Image src={diyImage} alt="Tactile Wood" fill className="object-cover" />
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <h3 className="text-3xl font-bold font-serif leading-tight">{s2Title}</h3>
          <p className="text-sm text-[#5C564E] leading-relaxed">{s2Desc}</p>
          <div className="relative aspect-video w-full rounded-2xl overflow-hidden border border-[#E1DDD5]">
            <Image src={techImage} alt="Clutter Free" fill className="object-cover" />
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <h3 className="text-3xl font-bold font-serif leading-tight">{s3Title}</h3>
          <p className="text-sm text-[#5C564E] leading-relaxed">{s3Desc}</p>
          <div className="relative aspect-video w-full rounded-2xl overflow-hidden border border-[#E1DDD5]">
            <Image src={heroImage} alt="Bảo vệ sức khỏe" fill className="object-cover" />
          </div>
        </div>
      </div>

      <motion.div ref={containerRef} style={{ backgroundColor }} className="hidden md:block relative h-[300vh] w-full">
            ...
            <div className="w-[100vw] h-full shrink-0 flex items-center justify-center px-12">
              <div className="mx-auto max-w-7xl w-full grid grid-cols-12 gap-16 items-center">
                <div className="col-span-6 space-y-6 text-left">
                  ...
                  <h2 className="text-5xl font-bold font-serif text-black leading-tight">{s1Title}</h2>
                  <p className="text-sm text-[#5C564E] leading-relaxed max-w-md">{s1Desc}</p>
                </div>
            ...
            <div className="w-[100vw] h-full shrink-0 flex items-center justify-center px-12">
              <div className="mx-auto max-w-7xl w-full grid grid-cols-12 gap-16 items-center">
                <div className="col-span-6 space-y-6 text-left text-white">
                  ...
                  <h2 className="text-5xl font-bold font-serif text-[#FCFAF2] leading-tight">{s2Title}</h2>
                  <p className="text-sm text-neutral-400 max-w-md leading-relaxed">{s2Desc}</p>
                </div>
                <div className="col-span-6 relative aspect-square w-full rounded-3xl overflow-hidden border border-white/10 bg-neutral-900 shadow-2xl">
                  <Image src={techImage} alt="Tránh xao nhãng" fill className="object-cover opacity-90" />
                </div>
              </div>
            </div>
            ...
            <div className="w-[100vw] h-full shrink-0 flex items-center justify-center px-12">
              <div className="mx-auto max-w-7xl w-full grid grid-cols-12 gap-16 items-center">
                <div className="col-span-6 space-y-6 text-left text-white">
                  ...
                  <h2 className="text-5xl font-bold font-serif text-white leading-tight">{s3Title}</h2>
                  <p className="text-sm text-neutral-400 max-w-md leading-relaxed">{s3Desc}</p>
                </div>
                <div className="col-span-6 relative aspect-square w-full rounded-3xl overflow-hidden border border-amber-500/10 bg-neutral-950 shadow-2xl">
                  <Image src={heroImage} alt="Công thái học" fill className="object-cover opacity-85" />
                </div>
              </div>
            </div>
          </motion.div>
