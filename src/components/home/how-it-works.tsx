    ...
    <div className="w-[100vw] h-full shrink-0 flex flex-col justify-center bg-[#FCFAF2] px-24 font-sans select-none border-r border-[#E1DDD5]/50">
      <div className="max-w-6xl mx-auto w-full text-left">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-serif text-black font-bold mt-2">Sản phẩm sinh ra khi có bạn</h2>
        </motion.div>
          ...
          {steps.map((step, index) => (
            ...
            >
              <div>
                ...
                <p className="text-xs sm:text-sm text-[#5C564E] leading-relaxed font-sans">{step.desc}</p>
              </div>
